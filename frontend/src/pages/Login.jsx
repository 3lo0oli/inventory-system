    ...
    <div dir="rtl" style={{
      ...
      <div style={{ position: 'relative', zIndex: 10, width: '100%', maxWidth: '420px', margin: '0 auto' }}>
        ...
        <div style={{
          ...
          {/* Demo credentials */}
          <div style={{ marginTop: '20px', padding: '12px', backgroundColor: '#f0f9ff', borderRadius: '8px', border: '1px solid #bfdbfe' }}>
            <p style={{ fontSize: '12px', fontWeight: 600, color: '#1e40af', margin: '0 0 6px 0' }}>بيانات تجريبية:</p>
            <div dir="ltr" style={{ fontSize: '12px', color: '#1e40af', lineHeight: 1.8, textAlign: 'left' }}>
              <div>admin@inventory.com / admin123</div>
              <div>manager@inventory.com / manager123</div>
              <div>cashier@inventory.com / cashier123</div>
            </div>
          </div>
        </div>
